...
--/////////////////////////////////////////////////////////////////////////////
--
-- Simple Pickle module for LUA 5.1.1, version 1.0.3
--
-- Interface:
...
function pickle._pickle( indent, theTable )
	...
	local reserved = {["and"]=true,["break"]=true,["do"]=true,["else"]=true,["elseif"]=true,
	...
	for k,v in pairs(theTable) do
		...
		if type( v ) == "table" then
			...
			elseif not string.find( k, regex ) or reserved[k] then
				str = str.."[\""..kq.."\"] = {\r\n"..pickle._pickle( indent + 1, v )..string.rep( "\t", indent ).."}"
			else
				str = str..kq.." = {\r\n"..pickle._pickle( indent + 1, v )..string.rep( "\t", indent ).."}"
			end
		elseif type( v ) == "string" then
			...
			if type( k ) == "number" then
				str = str.."["..k.."] = "..vq
			elseif not string.find( kq, regex ) or reserved[kq] then
				str = str.."[\""..kq.."\"] = "..vq
			else
				str = str..kq.." = "..vq
			end
